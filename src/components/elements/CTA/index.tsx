...
export const CTA = ({ title, description, buttonText, href }: Props) => {
  return (
    <div>
      ...
      <div className="md:flex mx-auto bg-grayscale-500 rounded-lg items-center justify-evenly p-8 pb-10 mb-12 md:mb-24 shadow-3xl">
        <div className="md:pr-36 text-center md:text-left mb-6 md:mb-0">
          <h2 className="text-xl/8 font-bold sm uppercass mb-5 md:mb-2">
            {title}
          </h2>
