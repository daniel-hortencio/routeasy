            ...
            <>
              <div className="md:w-[56%]">
                ...
                <p>
                  ...
                  capacidade da sua frota. Com nossas soluções, sua operação
                  reduz prazos de entrega, evita falhas e elimina ineficiências
                  para otimizar custos operacionais. Além disso, você tem
                  visibilidade completa e em tempo real de todas as rotas em
                  andamento, mantendo seus clientes informados a cada etapa do
                  processo.
                </p>
              </div>
              <div className="w-[256px] h-[256px] relative hidden md:block">
            ...
            <>
              <div className="md:w-[56%]">
                ...
                <p>
                  ...
                  executa a roteirização e o despacho para os motoristas de
                  forma totalmente automática, sem qualquer trabalho manual. É
                  ideal operações complexas que envolvem diversos pontos de
                  origem, clientes e parceiros de entrega.
                </p>
              </div>
              <div className="w-[256px] h-[256px] relative hidden md:block">
                <Image
            ...
            <>
              <div className="md:w-[56%]">
                ...
                <p>
                  ...
                  inteligente, que garante visibilidade total da operação, além
                  de relatórios completos com indicadores de desempenho
                  relevantes, como taxas de sucesso na entrega/coleta, tempos de
                  espera em cada parada e quantidade de ocorrências por rota.
                </p>
              </div>
              <div className="w-[256px] h-[256px] relative hidden md:block">
                <Image
