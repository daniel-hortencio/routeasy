...
export const MenuMobileButton = ({ isOpen, onChange }: Props) => {
  return (
    <Box className="flex lg:hidden">
      ...
      <Box className="fill-primary hover:fill-primaryHover z-10 ">
      ...
      >
        {[
          ...
          <Link key={item.label} href={item.href}>
            <Text className="flex items-center justify-center h-12 border-b-1 border-primaryHover bg-primary text-white hover:bg-primaryHover ">
              {item.label}
            </Text>
          </Link>
        ))}
